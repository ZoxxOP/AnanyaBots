...
FONT_TITLE = "AnanyaMusic/assets/f (1).ttf"
FONT_AXIOM = "AnanyaMusic/assets/f (1).ttf"
FONT_META  = "AnanyaMusic/assets/cfont (1).ttf"
FONT_TIME  = "AnanyaMusic/assets/cfont (1).ttf"
...
async def get_thumb(videoid: str, progress_percent: int = 0, use_cache: bool = True, user_name: str = "Akash") -> str:
    ...
    try:
        ...
        draw.text((TITLE_X, PLAYER_Y), f"Player | @ShreyaxMusicBot",
                  fill=(190, 190, 190), font=axiom_font)
