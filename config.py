...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Dakshwanshi_Akash")
BOT_USERNAME = getenv("BOT_USERNAME", "ShreyaxMusicBot")
BOT_NAME = getenv("BOT_NAME", "ShreyaxMusic")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ZoxxOP/TeamAnanyaBots")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", "GIT_TOKEN")

                                                        
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/TeamAnanyaBots")
